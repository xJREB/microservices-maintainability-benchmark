# Maintainability Benchmark of Microservices
...
1. Carefully read the [rating guide](rating-scheme-guide.md), then download and examine the [rating scheme](raw/master/rating-scheme.xlsx).
